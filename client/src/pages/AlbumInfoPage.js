          ...
          <TableBody>
            {
              ...
              songData.map(item =>
                ...
                <TableCell key='#'>{item.number}</TableCell>
                <TableCell key='Title'>
                  <Link onClick={() => setSelectedSongId(item.song_id)}>
                    {item.title}
                  </Link>
                </TableCell>
                <TableCell key='Plays'>{item.plays}</TableCell>
                <TableCell key='Duration'>{formatDuration(item.duration)}</TableCell>
              </TableRow>
              )
